  ...
  <div id="stag-admin-wrap">
    <form action="<?php echo site_url() .'/wp-admin/admin-ajax.php'; ?>" method="post" id="stag-form">
      <div class="stag-header">
        ...
        <p>
          by <a href="http://themeforest.net/user/Codestag/portfolio" target="_blank">Codestag</a>
          ...
          &middot; <a href="//support.codestag.com" target="_blank" title="Codestag Support">Support</a>
          <?php endif; ?>
        </p>
...
function stag_support() { ?>
    <script type="text/javascript">
        //<![CDATA[
            window.location.replace("http://support.codestag.com");
        //]]>
    </script>
<?php }