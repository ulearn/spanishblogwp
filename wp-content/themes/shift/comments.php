    ...
    if ( have_comments() ) : // if there are comments ?>
        ...
        <div id="comment-wrap">
            <div class="inner-block">
                ...
                <h3 id="comments"><?php comments_number(__('0 Comments', 'stag'), __('1 Comment', 'stag'), __('% Comments', 'stag')); ?><a href="#respond" class="button respond-button accent-background"><span class="continue-reading "><?php comment_form_title( __('Leave a Comment', 'stag'), __('Leave a Comment', 'stag') ); ?></span></a></h3>
                </div>
...
/*-----------------------------------------------------------------------------------*/
  ...
  <div id="respond-wrap" class="clearfix">
    <div id="respond" class="clearfix">
      <i class="icon icon-triangle comment-icon"></i>
  ...
  $aria_req = ( $req ? " aria-required='true'" : '' );
      $fields = array(
              ...
              'comment_notes_after' => '',
              'title_reply' => __('Leave a Comment<span class="section-description">Please be polite. We appreciate that.</span>', 'stag'),
